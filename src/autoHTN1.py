...
def make_method(name, rule):
    def method(state, ID):
        ...
        c = [
            ("have_enough", ID, "ingot", 0),
            ("have_enough", ID, "coal", 0),
            ("have_enough", ID, "ore", 0),
            ("have_enough", ID, "cobble", 0),
            ("have_enough", ID, "stick", 0),
            ("have_enough", ID, "plank", 0),
            ("have_enough", ID, "wood", 0),
        ]
        for check in c:
...
def add_heuristic(data, ID):
    ...
    def heuristic(state, curr_task, tasks, plan, depth, calling_stack):
        ...
        if (
            ...
            and 
                have_enough_stone_axe in calling_stack
        ):
            return True
...
if __name__ == "__main__":
    ...
    # pyhop.pyhop(state, [('have_enough', 'agent', 'stone_pickaxe', 1)], verbose=1)
